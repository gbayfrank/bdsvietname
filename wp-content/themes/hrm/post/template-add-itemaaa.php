                ...
                <div class="row-item">
                    <div class="row">
                        <div class="col-sm-6 col-xs-6">
                            ...
                            <input name="post_name_contact" id="post_name_contact" type="text" value="" required>
                        </div>
                        <div class="col-sm-6 col-xs-6">
                            <div class="labelwrapper">
                                <label>
                            ...
                            <input required name="post_phone_contact" id="post_phone_contact" type="text" value=""  data-pattern="^[0-9]+$">
                        </div>
                    </div>
                </div>
                <div class="row-item">
