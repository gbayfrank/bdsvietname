...
<!-------------------------------------------------thong tin cơ bản begin----------------------------------------------------------------------------------->							
<div style="border: 1px solid rgb(22,71,156); padding: 20px; margin: -20px" name="thông tin cơ bản"> 
                                <div class="row-item">
                                    <div class="h2">
...
<!---------------------------------------------------------------------thông tin cơ bản end component------------------------------------------------------------------------------------------>
<div style="min-height: 60px; background: none;" name="deivder"></div>
<!--*******************************************************************thông tin khác begin component*******************************************************************************************-->
<div style="border: 1px solid rgb(22,71,156); padding: 20px; margin: -20px" name="thông tin khác">
                    <div class="row-item">
                        <div class="h2">
                            <span><?php _e( 'Thông tin khác','hrm' ); ?></span>
                        </div>
                     </div>
					<div class="row-item post-area">
                     <div class="row">
...
<!--*************************************************************************-thông tin khác end component *******************************************************************************************-->
<div style="min-height: 60px; background: none;" name="deivder"></div>
<!--*************************************************************************-thông tin liên hệ begin component *******************************************************************************************-->
<div style="border: 1px solid rgb(22,71,156); padding: 20px; margin: -20px" name="thông tin liên hệ">
                <div class="row-item">
                    <div class="h2">
...
<!--*************************************************************************-thông tin liên hệ end component *******************************************************************************************-->
<div style="min-height: 60px; background: none;" name="deivder"></div>
<!--*************************************************************************-mô tả chi tiết begin component *******************************************************************************************-->
<div style="border: 1px solid rgb(22,71,156); padding: 20px; margin: -20px" name="mô tả chi tiết">
...
<!--*************************************************************************mô tả chi tiết end component *******************************************************************************************-->			
<!--*************************************************************************Hình ảnh begin component *******************************************************************************************-->
<div style="min-height: 60px; background: none;" name="deivder"></div>
<div style="border: 1px solid rgb(22,71,156); padding: 20px; margin: -20px" name="mô tả chi tiết">
                    <div class="row-item">
                        <div class="h2">
                            <span><?php _e( 'Hình ảnh','hrm' ); ?></span>
                            <!--<span class="colour">*</span>-->
                    </div>
...
<!--************************************************************************* hình ảnh end component *******************************************************************************************-->
<!--************************************************************************* bản đồ begin component *******************************************************************************************-->
<div style="min-height: 60px; background: none;" name="deivder"></div>
<div style="border: 1px solid rgb(22,71,156); padding: 20px; margin: -20px" name="bản đồ">
			<div class="row-item">
				<div class="h2">
